...
cv2.imshow('IMAGEN 7 (ENFOQUE)', img6)
    #ANÁLISIS DE SILUETA
escaladegrises = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
img_final = cv2.Canny(escaladegrises, 100, 200)
