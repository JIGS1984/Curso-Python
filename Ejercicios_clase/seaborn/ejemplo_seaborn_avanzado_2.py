...
#3. VISIONAMOS EL PRIMER RESULTADO... (ESTÁNDAR EN EL EJE X)
...
#7. EL ATRIBUTO STAT() CONTROLA EN NÚMERO DE OBSERVACIONES
...
sns.histplot(x = ejex, kde = True, color = "green", alpha=0.5, fill = False)
plt.show()

sns.histplot(x = ejex, kde = True, color = "green", alpha=0.25)
plt.show()
